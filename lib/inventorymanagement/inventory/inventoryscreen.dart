...
import 'package:SmartBudget/inventorymanagement/configs/myconfig.dart';
import 'package:SmartBudget/inventorymanagement/inventory/addinventoryscreen.dart';
import 'package:SmartBudget/inventorymanagement/inventory/editinventoryscreen.dart';
import 'package:SmartBudget/inventorymanagement/inventory/inventorydetailscreen.dart';
import 'package:SmartBudget/inventorymanagement/models/inventory.dart';
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          if (index < inventoryList.length) {
                            ...
                            double stockRate = int.parse(currentInventory
                                    .inventoryQuantity
                                    .toString()) /
                                int.parse(currentInventory
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    padding:
                                        EdgeInsets.only(right: textSize / 2),
                                    decoration: BoxDecoration(
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        "(${currentInventory.inventoryQuantity}/${currentInventory.inventoryMaximumQuantity})",
                                        style: TextStyle(
